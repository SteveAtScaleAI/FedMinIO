...
import (
	...
	"github.com/fedminio/server/internal/logger/target/http"
	"github.com/fedminio/server/internal/logger/target/kafka"
	types "github.com/fedminio/server/internal/logger/target/loggertypes"
)
