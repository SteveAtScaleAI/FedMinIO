...
import (
	...
	"github.com/fedminio/server/internal/s3select/csv"
	"github.com/fedminio/server/internal/s3select/json"
	"github.com/fedminio/server/internal/s3select/parquet"
	"github.com/fedminio/server/internal/s3select/simdj"
	"github.com/fedminio/server/internal/s3select/sql"
