...
import (
	...
	"github.com/fedminio/server/internal/config/browser"

	"github.com/minio/madmin-go/v3"
	"github.com/fedminio/server/internal/config"
	"github.com/fedminio/server/internal/config/api"
	"github.com/fedminio/server/internal/config/batch"
	"github.com/fedminio/server/internal/config/callhome"
	"github.com/fedminio/server/internal/config/compress"
	"github.com/fedminio/server/internal/config/dns"
	"github.com/fedminio/server/internal/config/drive"
	"github.com/fedminio/server/internal/config/etcd"
	"github.com/fedminio/server/internal/config/heal"
	xldap "github.com/fedminio/server/internal/config/identity/ldap"
	"github.com/fedminio/server/internal/config/identity/openid"
	idplugin "github.com/fedminio/server/internal/config/identity/plugin"
	xtls "github.com/fedminio/server/internal/config/identity/tls"
	"github.com/fedminio/server/internal/config/ilm"
	"github.com/fedminio/server/internal/config/lambda"
	"github.com/fedminio/server/internal/config/notify"
	"github.com/fedminio/server/internal/config/policy/opa"
	polplugin "github.com/fedminio/server/internal/config/policy/plugin"
	"github.com/fedminio/server/internal/config/scanner"
	"github.com/fedminio/server/internal/config/storageclass"
	"github.com/fedminio/server/internal/config/subnet"
