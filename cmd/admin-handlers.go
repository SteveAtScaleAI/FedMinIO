...
import (
	...
	"github.com/fedminio/server/internal/dsync"
...
// ServerUpdateV2Handler - disabled in FedMinIO (air-gapped environment).
...
// ServerUpdateHandler - disabled in FedMinIO (air-gapped environment).
